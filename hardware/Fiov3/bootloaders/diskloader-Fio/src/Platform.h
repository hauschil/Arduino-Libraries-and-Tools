...
//define USB_PID_LEONARDO 0x0003
//#define USB_PID_MICRO 0x0003
#define USB_PID_FIO 0x0004
#define USB_VID 0x1B4F	// sparkfun vid
...
#define OEM_NAME		'p','r','o','m','i','c','r','o'					// 8 chars chchchchanges
