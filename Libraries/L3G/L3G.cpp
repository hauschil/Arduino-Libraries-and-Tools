...
// Turns on the L3G's gyro and places it in normal mode. Additionally sets data output rate
void L3G::enableCarrera(void)
{
  ...
  // 0X10 = 0b00010000 // 500 dps
   writeReg(L3G_CTRL_REG4, 0x10);
   
   writeReg(L3G_FIFO_CTRL_REG, 0b01000000);
   writeReg(L3G_CTRL_REG5, 0b0100000000);
}
