...
// Turns on the LSM303's accelerometer and magnetometers and places them in normal
// mode. Additionally sets the data output rate of acc and mag.
void LSM303::enableCarrera(void)
{
  // Enable Accelerometer
  // 0x27 = 0b00100111  10 Hz
  // 0x57 = 0b01010111  100 Hz
  // 0x67 = 0b01100111  200 Hz
  // 0x77 = 0b01110111  400 Hz
  // Normal power mode, all axes enabled
  writeAccReg(LSM303_CTRL_REG1_A, 0x57);
  ...
  // 0x18 = 0b00011000  75 Hz
  // 0x1C = 0b00011100  220 Hz
  writeMagReg(LSM303_CRA_REG_M,0x18);
}
